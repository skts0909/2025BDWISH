...
const messages = [
  "YOO MADAMI JIIIII...",
  "ITS YOUR SPECIAL DAYYY ;)",
  "I SWEAR NEXT TIME TAK I WILL LEARN WEB DEVELOPMENT AND ALL (crying emoji)..ABHI JYADE NAI BUT IVE CUSTOMISED THE WHOLE WEBSITE FOR U...",
  "I HOPE U LIKE IT<<3...LETS BEGIN...;) "
];
